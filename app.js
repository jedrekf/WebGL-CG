...
var App = function () {
    ...
    function drawScene () {
        ...
        /**
         * Sun lighting uniforms information and camera position for phong
         */
        //send current cam position for specular in phong
        var vectorCameraUniform = gl.getUniformLocation(programs[0], 'cameraDirection');
        var ambientLightintensityUniform = gl.getUniformLocation(programs[0], 'ambientLightIntensity');
        var sunlightIntensityUniform = gl.getUniformLocation(programs[0], 'sunlightIntensity');
        var sunlightDirectionUnform = gl.getUniformLocation(programs[0], 'sunlightDirection');
        var specularIntensityUniform = gl.getUniformLocation(programs[0], 'specularIntensity');
        gl.uniform3fv(vectorCameraUniform, new Float32Array(center));
        gl.uniform3fv(ambientLightintensityUniform, new Float32Array([0.5, 0.5, 0.5]));
        gl.uniform3fv(sunlightIntensityUniform, new Float32Array([0.6, 0.6, 0.6]));
        gl.uniform3fv(sunlightDirectionUnform, new Float32Array([100.0, 100.0, -15.0]));
        gl.uniform3fv(specularIntensityUniform, new Float32Array([0.1, 0.1, 0.1]));
